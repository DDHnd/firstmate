...
- `/bearings lavish` adds an interactive fleet board beside the chat digest.
  Use a row's **Copy** button to copy its report path, then open that path locally; PR links open directly in the browser.
